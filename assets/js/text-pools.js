...
const TEXT_POOL_SOCIAL = {
  ...
  rankings: [
    ...
    { persona: 'data', tone: 'neutral', text: '最新最佳第六人赔率：{teamName}的替补得分手排在第3，场均18分的板凳火力太香了。' },
...
const TEXT_POOL_SCOUT = {
  ...
  sg_mid: [
    ...
    { summary: '一位以第六人角色出色发挥的得分后卫，他替补上场后的火力输出经常改变比赛走势。', projection: '预计首轮末段被选中，最佳第六人型球员。', strengths: ['替补上场后的火力输出惊人', '不需要热身就能得分'], weaknesses: ['作为首发的表现不如替补'] },
